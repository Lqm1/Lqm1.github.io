...
export default function CustomCursor() {
	...
	useEffect(() => {
		...
		// Set initial visibility based on touch device detection
	...
	// Separate useEffect for trail animation
	useEffect(() => {
	...
	return (
        ...
        `}</style>
			...
			{/* Only render cursor elements if not on touch device and cursor is visible */}
